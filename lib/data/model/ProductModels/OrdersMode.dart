class OrdersModel {
  ...
  String? ordersDaddressid;
  String? ordersBaddressid;
  String? ordersPrice;
  String? ordersPaymentType;
  String? ordersDeliveryType;
  String? ordersGiftstatus;
  String? ordersStatus;
  String? ordersDatetime;
  String? ordersSudatetime;
  String? ordersSdatetime;
  String? ordersDdatetime;
  String? itemsPrice;
  String? countitems;
  String? cartId;
  String? cartUsersid;
  ...
  OrdersModel(
      {this.ordersId,
      this.ordersUsersid,
      this.ordersDaddressid,
      this.ordersBaddressid,
      this.ordersPrice,
      this.ordersPaymentType,
      this.ordersDeliveryType,
      this.ordersGiftstatus,
      this.ordersStatus,
      this.ordersDatetime,
      this.ordersSudatetime,
      this.ordersSdatetime,
      this.ordersDdatetime,
      this.itemsPrice,
      this.countitems,
      this.cartId,
      this.cartUsersid,
  ...
  OrdersModel.fromJson(Map<String, dynamic> json) {
    ...
    ordersDaddressid = json['orders_Daddressid'];
    ordersBaddressid = json['orders_Baddressid'];
    ordersPrice = json['orders_price'];
    ordersPaymentType = json['orders_paymentType'];
    ordersDeliveryType = json['orders_deliveryType'];
    ordersGiftstatus = json['orders_giftstatus'];
    ordersStatus = json['orders_status'];
    ordersDatetime = json['orders_datetime'];
    ordersSudatetime = json['orders_sudatetime'];
    ordersSdatetime = json['orders_sdatetime'];
    ordersDdatetime = json['orders_ddatetime'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['orders_Daddressid'] = this.ordersDaddressid;
    data['orders_Baddressid'] = this.ordersBaddressid;
    data['orders_price'] = this.ordersPrice;
    data['orders_paymentType'] = this.ordersPaymentType;
    data['orders_deliveryType'] = this.ordersDeliveryType;
    data['orders_giftstatus'] = this.ordersGiftstatus;
    data['orders_status'] = this.ordersStatus;
    data['orders_datetime'] = this.ordersDatetime;
    data['orders_sudatetime'] = this.ordersSudatetime;
    data['orders_sdatetime'] = this.ordersSdatetime;
    data['orders_ddatetime'] = this.ordersDdatetime;
    ...
    data['items_price'] = this.cartPrice;
